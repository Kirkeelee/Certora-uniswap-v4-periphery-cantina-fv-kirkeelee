...
library PositionInfoLibrary {
    ...
    function poolId(PositionInfo info) internal pure returns (bytes25 _poolId) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff009f0000, 1037618708639) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff009f0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff009f1000, info) }
        assembly ("memory-safe") {
            _poolId := and(MASK_UPPER_200_BITS, info)
        }
    }

    function tickLower(PositionInfo info) internal pure returns (int24 _tickLower) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a00000, 1037618708640) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a00001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a01000, info) }
        assembly ("memory-safe") {
            _tickLower := signextend(2, shr(TICK_LOWER_OFFSET, info))
        }
    }

    function tickUpper(PositionInfo info) internal pure returns (int24 _tickUpper) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a20000, 1037618708642) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a20001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a21000, info) }
        assembly ("memory-safe") {
            _tickUpper := signextend(2, shr(TICK_UPPER_OFFSET, info))
        }
    }

    function hasSubscriber(PositionInfo info) internal pure returns (bool _hasSubscriber) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a30000, 1037618708643) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a30001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a31000, info) }
        assembly ("memory-safe") {
    ...
    /// @dev this does not actually set any storage
    function setUnsubscribe(PositionInfo info) internal pure returns (PositionInfo _info) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a40000, 1037618708644) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a40001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a41000, info) }
        assembly ("memory-safe") {
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a50000, 1037618708645) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a50001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a51000, _poolKey) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a51001, _tickLower) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00a51002, _tickUpper) }
