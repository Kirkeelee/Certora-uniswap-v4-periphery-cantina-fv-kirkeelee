...
abstract contract DeltaResolver is ImmutableState {
    ...
    function _take(Currency currency, address recipient, uint256 amount) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007a0000, 1037618708602) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007a0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007a1000, currency) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007a1001, recipient) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007a1002, amount) }
    ...
    function _settle(Currency currency, address payer, uint256 amount) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007b0000, 1037618708603) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007b0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007b1000, currency) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007b1001, payer) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007b1002, amount) }
    ...
    function _getFullDebt(Currency currency) internal view returns (uint256 amount) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007d0000, 1037618708605) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007d0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007d1000, currency) }
    ...
    function _getFullCredit(Currency currency) internal view returns (uint256 amount) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007c0000, 1037618708604) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007c0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007c1000, currency) }
        int256 _amount = poolManager.currencyDelta(address(this), currency);
    ...
    function _mapSettleAmount(uint256 amount, Currency currency) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007e0000, 1037618708606) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007e0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007e1000, amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff007e1001, currency) }
