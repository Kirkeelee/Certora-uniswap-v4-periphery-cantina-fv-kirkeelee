...
/*
rule DecreaseLiquidityWithZeroAmount(env e) {
    uint256 tokenId; uint256 liquidity; uint128 amount0Max; uint128 amount1Max; bytes hookData;
    ...
    decreaseLiquidity(e, tokenId, liquidity, amount0Max, amount1Max, hookData);
...
rule onlyMintingchangesTokenID (method f, env e, calldataarg args) filtered {
    f -> f.selector != sig:mintPosition(PoolKey, int24, int24, uint256, uint128, uint128, address, bytes).selector }{
