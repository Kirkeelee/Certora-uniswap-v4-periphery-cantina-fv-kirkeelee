...
rule swapExactInSingleRevertingConditions (env e) {
   ...
   IV4Router.ExactOutputSingleParams params;
    address swapper;
    require params.amountOut < max_uint128;
    mathint amountIn = swapMock(swapper, params.poolKey, params.zeroForOne, params.amountOut, params.sqrtPriceLimitX96);
    require params.amountOut < max_uint128 && amountIn < max_uint128;

    swapExactOutSingle@withrevert(e, params);

    assert (require_uint128(amountIn) > params.amountInMaximum) => lastReverted;
