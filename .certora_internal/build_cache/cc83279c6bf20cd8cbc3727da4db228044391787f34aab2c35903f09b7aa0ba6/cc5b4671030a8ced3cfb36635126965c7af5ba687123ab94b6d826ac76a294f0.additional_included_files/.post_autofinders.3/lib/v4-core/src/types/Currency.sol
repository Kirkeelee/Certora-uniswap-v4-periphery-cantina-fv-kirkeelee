...
library CurrencyLibrary {
    ...
    function transfer(Currency currency, address to, uint256 amount) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00600000, 1037618708576) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00600001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00601000, currency) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00601001, to) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00601002, amount) }
    ...
    function balanceOfSelf(Currency currency) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00610000, 1037618708577) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00610001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00611000, currency) }
        if (currency.isAddressZero()) {
    ...
    function balanceOf(Currency currency, address owner) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00630000, 1037618708579) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00630001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00631000, currency) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00631001, owner) }
        if (currency.isAddressZero()) {
    ...
    function isAddressZero(Currency currency) internal pure returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00640000, 1037618708580) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00640001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00641000, currency) }
        return Currency.unwrap(currency) == Currency.unwrap(ADDRESS_ZERO);
    }

    function toId(Currency currency) internal pure returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00620000, 1037618708578) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00620001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00621000, currency) }
        return uint160(Currency.unwrap(currency));
    }

    // If the upper 12 bytes are non-zero, they will be zero-ed out
    // Therefore, fromId() and toId() are not inverses of each other
    function fromId(uint256 id) internal pure returns (Currency) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00650000, 1037618708581) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00650001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00651000, id) }
