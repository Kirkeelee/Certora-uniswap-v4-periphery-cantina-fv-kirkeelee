...
rule swapExactInSingleRevertingConditions (env e) {
   IV4Router.ExactInputSingleParams params;
    address swapper;
    int256 amountSpecified;
    require amountSpecified == params.amountIn;
    mathint amountOut = swapMock(swapper, params.poolKey, params.zeroForOne, -(require_int256(amountSpecified)), params.sqrtPriceLimitX96);
