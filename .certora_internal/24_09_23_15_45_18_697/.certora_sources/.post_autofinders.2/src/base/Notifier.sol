...
abstract contract Notifier is INotifier {
    ...
    function _unsubscribe(uint256 tokenId) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00810000, 1037618708609) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00810001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00811000, tokenId) }
        ISubscriber _subscriber = subscriber[tokenId];
    ...
    function _notifyModifyLiquidity(uint256 tokenId, int256 liquidityChange, BalanceDelta feesAccrued) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00800000, 1037618708608) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00800001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00801000, tokenId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00801001, liquidityChange) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00801002, feesAccrued) }
        ISubscriber _subscriber = subscriber[tokenId];
    ...
    function _notifyTransfer(uint256 tokenId, address previousOwner, address newOwner) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00820000, 1037618708610) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00820001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00821000, tokenId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00821001, previousOwner) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00821002, newOwner) }
        ISubscriber _subscriber = subscriber[tokenId];
    ...
    function _call(address target, bytes memory encodedCall) internal returns (bool success) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00830000, 1037618708611) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00830001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00831000, target) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00831001, encodedCall) }
