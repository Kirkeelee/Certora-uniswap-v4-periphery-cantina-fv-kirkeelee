...
contract PositionManagerHarness is PositionManager {
    ...
    return _isApprovedOrOwner(spender, tokenId);
     ...
     function getTicks(PositionInfo info) public pure returns (int24 lowerTick, int24 upperTick) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff002c0000, 1037618708524) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff002c0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff002c1000, info) }
        lowerTick = PositionInfoLibrary.tickLower(info); // Call the library function to get tickLower
        upperTick = PositionInfoLibrary.tickUpper(info); // Call the library function to get tickUpper
    }
