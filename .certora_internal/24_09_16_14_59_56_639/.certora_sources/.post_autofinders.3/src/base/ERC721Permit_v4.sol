...
abstract contract ERC721Permit_v4 is ERC721, IERC721Permit_v4, EIP712_v4, UnorderedNonce {
    ...
    function _approveForAll(address owner, address operator, bool approved) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00820000, 1037618708610) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00820001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00821000, owner) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00821001, operator) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00821002, approved) }
    ...
    function approve(address spender, uint256 id) public override {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff002d0000, 1037618708525) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff002d0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff002d1000, spender) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff002d1001, id) }
    ...
    function _approve(address owner, address spender, uint256 id) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00830000, 1037618708611) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00830001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00831000, owner) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00831001, spender) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00831002, id) }
        getApproved[id] = spender;
        emit Approval(owner, spender, id);
    }

    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00840000, 1037618708612) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00840001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00841000, spender) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00841001, tokenId) }
