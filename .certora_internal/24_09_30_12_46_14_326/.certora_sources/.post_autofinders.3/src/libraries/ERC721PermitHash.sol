...
library ERC721PermitHash {
    ...
    function hashPermitForAll(address operator, bool approved, uint256 nonce, uint256 deadline)
        ...
        pure
        returns (bytes32 digest)
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff009d0000, 1037618708637) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff009d0001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff009d1000, operator) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff009d1001, approved) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff009d1002, nonce) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff009d1003, deadline) }
