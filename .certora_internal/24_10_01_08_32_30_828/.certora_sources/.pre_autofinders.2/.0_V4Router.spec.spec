...
rule ValidPathCheck (env e) {
    ...
    require pathLength < 3; // For multi-hop swaps

    swapExactIn(e, params);

    assert params.path[pathLength].intermediateCurrency != params.path[require_int256(pathLength + 1)].intermediateCurrency;
