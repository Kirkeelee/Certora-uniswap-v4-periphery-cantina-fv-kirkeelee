...
rule swapExactInSingleRevertingConditions (env e) {
   IV4Router.ExactInputSingleParams params;
    ...
    require params.amountIn < max_uint128;
    Conversions.BalanceDelta delta = swapMock(swapper, params.poolKey, params.zeroForOne, -(require_int128(params.amountIn), params.sqrtPriceLimitX96);
