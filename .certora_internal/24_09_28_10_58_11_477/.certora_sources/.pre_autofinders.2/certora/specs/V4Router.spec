...
rule swapExactInSingleRevertingConditions (env e) {
   IV4Router.ExactInputSingleParams params;
    ...
    Conversions.BalanceDelta delta = swapMock(swapper, params.poolKey, params.zeroForOne, require_int256(-require_int256(amounSpecified)), params.sqrtPriceLimitX96);
