...
abstract contract V4Router is IV4Router, BaseActionsRouter, DeltaResolver {
    ...
    function _handleAction(uint256 action, bytes calldata params) internal override virtual /* add virtual AT@Certora */ {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00440000, 1037618708548) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00440001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00440005, 90) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00446101, params.offset) }
    ...
    function _swapExactInputSingle(IV4Router.ExactInputSingleParams calldata params) internal /* pirvate to internal AT@Certora */ {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00460000, 1037618708550) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00460001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00460005, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00466200, params) }
    ...
    function _swapExactInput(IV4Router.ExactInputParams calldata params) internal /* pirvate to internal AT@Certora */ {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00470000, 1037618708551) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00470001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00470005, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00476200, params) }
        unchecked {
    ...
    function _swapExactOutputSingle(IV4Router.ExactOutputSingleParams calldata params) internal /* pirvate to internal AT@Certora */ {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00450000, 1037618708549) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00450001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00450005, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00456200, params) }
    ...
    function _swapExactOutput(IV4Router.ExactOutputParams calldata params) internal /* pirvate to internal AT@Certora */ {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00480000, 1037618708552) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00480001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00480005, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00486200, params) }
        unchecked {
            // Caching for gas savings
            uint256 pathLength = params.path.length;
            uint128 amountIn;
    ...
    ) internal /* pirvate to internal AT@Certora */ returns (int128 reciprocalAmount) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00490000, 1037618708553) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00490001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00490005, 37466) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00496104, hookData.offset) }
        unchecked {
