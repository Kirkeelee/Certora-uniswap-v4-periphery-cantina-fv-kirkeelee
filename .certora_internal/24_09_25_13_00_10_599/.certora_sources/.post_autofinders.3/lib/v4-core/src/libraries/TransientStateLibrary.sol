...
library TransientStateLibrary {
    ...
    function getNonzeroDeltaCount(IPoolManager manager) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005c0000, 1037618708572) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005c0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005c1000, manager) }
    ...
    function currencyDelta(IPoolManager manager, address target, Currency currency) internal view returns (int256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005d0000, 1037618708573) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005d0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005d1000, manager) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005d1001, target) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005d1002, currency) }
        bytes32 key;
    ...
    function isUnlocked(IPoolManager manager) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005b0000, 1037618708571) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005b0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005b1000, manager) }
