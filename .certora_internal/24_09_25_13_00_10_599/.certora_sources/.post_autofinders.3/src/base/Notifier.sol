...
abstract contract Notifier is INotifier {
    ...
    function _unsubscribe(uint256 tokenId) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00870000, 1037618708615) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00870001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00871000, tokenId) }
        ISubscriber _subscriber = subscriber[tokenId];
    ...
    function _notifyModifyLiquidity(uint256 tokenId, int256 liquidityChange, BalanceDelta feesAccrued) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00860000, 1037618708614) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00860001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00861000, tokenId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00861001, liquidityChange) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00861002, feesAccrued) }
        ISubscriber _subscriber = subscriber[tokenId];
    ...
    function _notifyTransfer(uint256 tokenId, address previousOwner, address newOwner) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00880000, 1037618708616) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00880001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00881000, tokenId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00881001, previousOwner) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00881002, newOwner) }
        ISubscriber _subscriber = subscriber[tokenId];
    ...
    function _call(address target, bytes memory encodedCall) internal returns (bool success) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00890000, 1037618708617) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00890001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00891000, target) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00891001, encodedCall) }
