...
rule swapExactInSingleRevertingConditions (env e) {
   IV4Router.ExactInputSingleParams params;
    ...
    int256 amounSpecified = (params.amountIn);
    require amounSpecified < 0;
    Conversions.BalanceDelta delta = swapMock(swapper, params.poolKey, params.zeroForOne, amounSpecified, params.sqrtPriceLimitX96);
