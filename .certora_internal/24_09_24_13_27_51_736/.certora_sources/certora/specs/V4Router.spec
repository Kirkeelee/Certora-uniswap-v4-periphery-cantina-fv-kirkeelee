...
rule noBalanceOnRouter (env e, method f, calldataarg args) {

    uint256 balanceBefore = balanceOfCVL(e, currentContract);

    f(e, args);

    uint256 balanceAfter = balanceOfCVL(e, currentContract);
