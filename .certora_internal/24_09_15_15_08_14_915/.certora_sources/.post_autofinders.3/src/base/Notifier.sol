...
abstract contract Notifier is INotifier {
    ...
    function _notifyModifyLiquidity(uint256 tokenId, int256 liquidityChange, BalanceDelta feesAccrued) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00850000, 1037618708613) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00850001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00851000, tokenId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00851001, liquidityChange) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00851002, feesAccrued) }
        ISubscriber _subscriber = subscriber[tokenId];
    ...
    function _notifyTransfer(uint256 tokenId, address previousOwner, address newOwner) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00870000, 1037618708615) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00870001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00871000, tokenId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00871001, previousOwner) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00871002, newOwner) }
        ISubscriber _subscriber = subscriber[tokenId];
    ...
    function _call(address target, bytes memory encodedCall) internal returns (bool success) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00880000, 1037618708616) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00880001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00881000, target) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00881001, encodedCall) }
