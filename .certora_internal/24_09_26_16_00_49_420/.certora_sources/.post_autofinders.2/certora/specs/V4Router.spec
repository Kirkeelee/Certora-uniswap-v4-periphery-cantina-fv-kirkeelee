...
rule swapExactInSingleRevertingConditions (env e) {
   ...
   IV4Router.ExactOutputSingleParams params;
    ...
    mathint amountOut = swapMock(swapper, params.poolKey, params.zeroForOne, params.amountOut, params.sqrtPriceLimitX96);

    swapExactOutSingle@withrevert(e, params);

    assert (require_uint128(amountOut) > params.amountInMaximum) => lastReverted;
